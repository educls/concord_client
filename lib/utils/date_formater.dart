...
class DateFormatter {
  ...
  DateTime brasiliaDateTime = dateTime.toUtc().add(Duration(hours: -3));

  String hourFormatted = "${brasiliaDateTime.hour.toString().padLeft(2, '0')}:${brasiliaDateTime.minute.toString().padLeft(2, '0')}";
